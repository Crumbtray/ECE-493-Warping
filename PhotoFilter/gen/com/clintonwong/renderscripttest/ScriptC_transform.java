 ...
 * The source Renderscript file: /Users/Crumbs/ECE-493-Warping/PhotoFilter/src/com/photofilter/transform.rs
 */
...
public class ScriptC_transform extends ScriptC {
    ...
    private final static int mExportFuncIdx_rediculousBulge = 0;
    public void invoke_rediculousBulge() {
        invoke(mExportFuncIdx_rediculousBulge);
    }

    private final static int mExportFuncIdx_shrink = 1;
    public void invoke_shrink() {
        invoke(mExportFuncIdx_shrink);
    }

    private final static int mExportFuncIdx_bulge = 2;
    public void invoke_bulge() {
        invoke(mExportFuncIdx_bulge);
    }

    private final static int mExportFuncIdx_setPixelAt = 3;
