...
public class WarpActivity extends Activity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
	...
	public void undo()
	{
		...
		{
			undoStack.pop();
			Bitmap previousImage = undoStack.peek();
	...
	public void save()
	{
		String text = MediaStore.Images.Media.insertImage(this.getContentResolver(), currentImage, "Saved Image", "Saved Image");
